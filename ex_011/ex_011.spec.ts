import { findBiggestProduct } from "./ex_011";

describe("ex_011", () => {
    it("Simple case - Verticaly", () => {
        const GRID = [
            [1, 2, 3],
            [3, 9, 2],
            [8, 9, 1],
        ];
        const result = findBiggestProduct(GRID, 2);

        expect(result).toBe(81);
    });

    it("Simple case - Horizontaly", () => {
        const GRID = [
            [1, 2, 3],
            [3, 9, 9],
            [8, 3, 1],
    ...
    it("Simple case - diagonal left right", () => {
        const GRID = [
            [1, 2, 3],
            [3, 9, 2],
            [1, 2, 9],
    ...
    it("Simple case - diagonal right left", () => {
        const GRID = [
            [1, 2, 3],
            [3, 9, 2],
            [9, 2, 1],
    ...
    it("Exercise case - should be 70600674", () => {
        const GRID = [
            [
        ...
        const result = findBiggestProduct(GRID, 4);
